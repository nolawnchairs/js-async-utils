...
export declare namespace Async {
	 ...
	 * @returns {Promise<T>}
	 */
	function delayed<T>(ms: number, callback: AsyncSupplier<T> | Supplier<T>): Promise<T>;
	/**
	 ...
	 *
	 * @export
	 * @param {(Supplier<boolean | Promise<boolean>>)} condition the condition to
	 * be met
